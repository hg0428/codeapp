...
class XCObject:
  ...
  """
    ...
    """
        ...
        strip_value_quotes = key == "settings" and isinstance(self, PBXBuildFile)
        # In another one-off, let's set flatten_list on buildSettings properties
        # of XCBuildConfiguration objects, because that's how Xcode treats them.
        flatten_list = key == "buildSettings" and isinstance(
        ...
        try:
            ...
            printable += f"{printable_key} = {printable_value};{after_kv}"
            ...
            if do_copy:
                if isinstance(value, XCObject):
                    ...
                    if is_strong:
                        ...
                        self._properties[property] = [item.Copy() for item in value]
                    else:
                        self._properties[property] = value[:]
                elif isinstance(value, dict):
    ...
    def FullPath(self):
        ...
        while isinstance(xche, XCHierarchicalElement) and (
            ...
            if this_path is not None:
                path = posixpath.join(this_path, path) if path is not None else this_path
            xche = xche.parent
...
class PBXNativeTarget(XCTarget):
    ...
    def __init__(
        ...
        if (
            ...
            pbxproject = self.PBXProjectAncestor()
            products_group = pbxproject.ProductsGroup() if pbxproject is not None else None
    ...
    def HeadersPhase(self):
        ...
        if headers_phase is None:
            ...
            insert_at = next(
                ...
                len(self._properties["buildPhases"]),
            )
        ...
        if resources_phase is None:
            ...
            insert_at = next(
                (
                    ...
                    for index, phase in enumerate(self._properties["buildPhases"])
                    if isinstance(
                        phase, (PBXSourcesBuildPhase, PBXFrameworksBuildPhase)
                    )
                ),
                len(self._properties["buildPhases"]),
            )
